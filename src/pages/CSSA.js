    ...
    return (
        <dir>
            <Pinned
                ...
                rightCardTitle2="'Cool Young' Basketball-Freundschaftsspiel der CSSA München erfolgreich abgeschlossen" rightCardDate2="2022-04-08" rightCardImage2={rightCardImage2}/>
            />
            <Events type="CSSA"/>
        </dir>
    );
